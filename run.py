...
#x modelos para aprender
#y modelos esperados
#criar estruturas com camadas de entrada para aprender 


class Net(nn.Module):
    def __init__(self):
        super(Net, self).__init__()
        #atulizando para aceitar apenas 1 valor de entrada pois agora temos apenas a distância
        self.fc1 = nn.Linear(1,5) #de 2 p 1 na entrada
...
with torch.no_grad():
    ...
    print(f'Previsão de tempo de conclussão: {predicted.item()} min')
